                            ...
                            <div class="col-6">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <th>Tax ({{((((env('TAX_PERCENTAGE'))*($product->price))/100+(env('TAX_FIXED')))/($product->price))*100}}%)</th>
                                            <td>{{(((env('TAX_PERCENTAGE'))*($product->price))/100+(env('TAX_FIXED')))->formatCurrency()}}</td>
                                        </tr>
                                        <tr>
                                            <th>Quantity:</th>
                                            <td>1</td>
                                        ...
                                        <tr>
                                            <th>Total:</th>
                                            <td>{{($product->price)+((env('TAX_PERCENTAGE'))*($product->price))/100+(env('TAX_FIXED'))}}</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
