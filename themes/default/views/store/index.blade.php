...
@section('content')
    <style>
        ...
        .slider-2 input[type="range"]::-webkit-slider-thumb {
            -webkit-appearance: none !important;
            width: 20px;
            height: 20px;
            background: rgb(19, 132, 150);
        ...
        .slider-2 input[type="range"]::-webkit-slider-thumb:hover {
            background: radial-gradient(rgb(16, 200, 228), rgb(11, 74, 83));
        }
        ...
        .inward-border-div{
            ...
            box-shadow: inset 0 0 0 2px rgb(52, 58, 64), inset 0 0 0 3px rgb(77, 86, 94); 
        }
        .border-div{
            border-style:solid;
            border-color:rgb(77, 86, 94);
            border-width:1px;
            border-radius:0.5rem;
            padding:2px;
            padding-left:4px;
        ...
        .tool-tip .tool-tip-text-up::after {
        top: 100%;
                                                        ...
                                                        <div class="col-12">
                                                            <div class="mb-3 mt-2" style="position: relative; justify-content:center">
                                                                <label for="czk">
                                                                    ...
                                                                    <img height="40px" style="position: absolute; top: 50%; transform: translateY(-50%); margin-left: 20px" src="{{ asset('images/Flags/czech-flag.png') }}"/>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="tool-tip mb-2" style="position: relative; justify-content:center">
                                                                <label for="eur">
                                                                    ...
                                                                    <img height="40px" style="position: absolute; top: 50%; transform: translateY(-50%); margin-left: 20px" src="{{ asset('images/Flags/slovak-flag.png') }}"/>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="tool-tip mb-4 mt-3" style="position: relative; justify-content:center">
                                                                    <label for="paypal">
                                                                        ...
                                                                        <img height="40px" style="position: absolute; top: 50%; transform: translateY(-50%); margin-left: 20px" src="{{ asset('images/Extensions/PaymentGateways/paypal_logo.png') }}"/>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        @endif
                                                            ...
                                                            <div class="col-12">
                                                                <div class="tool-tip mb-4" style="position: relative; justify-content:center">
                                                                    <label for="stripe">
                                                                        ...
                                                                        <img height="40px" style="position: absolute; top: 50%; transform: translateY(-50%); margin-left: 20px" src="{{ asset('images/Extensions/PaymentGateways/stripe_logo.png') }}"/>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        @endif
                                                            ...
                                                            <div class="col-12">
                                                                <div class="tool-tip mb-3" style="position: relative; justify-content:center">
                                                                    <label for="gopay">
                                                                        ...
                                                                        <img height="40px" style="position: absolute; top: 50%; transform: translateY(-50%); margin-left: 20px" src="{{ asset('images/Extensions/PaymentGateways/gopay/gopay_logo.png') }}"/>
                                                                    </label>
