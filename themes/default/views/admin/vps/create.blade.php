                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a class="text-muted"
                                                       href="{{route('admin.vps.create')}}">{{__('Create')}}</a>
                        </li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <form action="{{route('admin.vps.store')}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{old('description')}}" placeholder="{{__('description')}}" id="description" name="description"
                                           type="text"
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{old('price')}}" placeholder="{{__('Price monthly')}}" id="price" name="price"
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{old('uuid')}}" placeholder="{{__('uuid')}}" id="uuid" name="uuid"
                                           type="text"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group date" id="last_payment" data-target-input="nearest">
                                        <input value="{{old('last_payment')}}" name="last_payment"
