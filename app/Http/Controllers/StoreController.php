...
class StoreController extends Controller
{
    ...
    public function index()
    {
        ...
        if (
            ...
            config("SETTINGS::PAYMENTS:GOPAY:GOID") && config("SETTINGS::PAYMENTS:GOPAY:CLIENT_ID") && config("SETTINGS::PAYMENTS:GOPAY:CLIENT_SECRET") && config("SETTINGS::PAYMENTS:STRIPE:METHODS")
        ) $isPaymentSetup = true;
